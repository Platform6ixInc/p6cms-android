...
import com.platform6ix.p6cms.data.gattble.CCCD_DESCRIPTOR_UUID
import com.platform6ix.p6cms.data.gattble.isIndicatable
import com.platform6ix.p6cms.data.gattble.isNotifiable
...
import com.platform6ix.p6cms.data.gattble.printGattTable
...
class FR8ProBeaconBleReceiveManager @Inject constructor(
        ...
        override fun onConnectionStateChange(
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                if (newState == BluetoothProfile.STATE_CONNECTED) {
                    ...
                    this@FR8ProBeaconBleReceiveManager.gatt = gatt
                } else if (newState == BluetoothProfile.STATE_DISCONNECTED) {
                    coroutineScope.launch {
                        data.emit(
                            Resource.Success(
                            data = FR8ProBeaconResult(
                                0f,
                                0f,
                                0f,
                                "Zone1",
            ...
            with(characteristic) {
                when(uuid) {
                    UUID.fromString(BEACON_CHARACTERISTICS_UUID) -> {
                        ...
                        val tempHumidityResult = FR8ProBeaconResult(

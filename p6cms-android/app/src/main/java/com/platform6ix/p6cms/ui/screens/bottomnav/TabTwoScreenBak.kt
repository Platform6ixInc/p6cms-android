...
import com.platform6ix.p6cms.data.beacon.BLEDevice
import com.platform6ix.p6cms.data.beacon.BLEDeviceItem
import com.platform6ix.p6cms.data.beacon.Beacon
import com.platform6ix.p6cms.data.beacon.IBeacon
import com.platform6ix.p6cms.data.blescanner.Utils
import com.platform6ix.p6cms.permissions.PermUtils
import com.platform6ix.p6cms.permissions.RequestMultiplePermissions
    ...
    val leScanCallback: ScanCallback = object : ScanCallback() {
        override fun onScanResult(callbackType: Int, result: ScanResult) {
            ...
            if (scanRecord != null) {
                ...
                val txPower =
                    com.platform6ix.p6cms.ui.screens.getTxPowerLevel(scanRecord.bytes)
